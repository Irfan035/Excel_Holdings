        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('admin.projectUpdate',$projects->id)}}" method="get" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="">Project Title</label>
                            <input type="text" name="title" class="form-control" value="{{$projects->title}}" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="body" id="body" cols="30" rows="10" class="ckeditor form-control" required>{{$projects->body}}</textarea>
                        </div>
