        ...
        <div class="card card-primary card-outline">
          <div class="card-body box-profile">
            <div class="text-center">
              <img class="profile-user-img img-fluid img-circle admin_picture" src="{{asset('img/'.Auth::user()->picture)}}" alt="{{Auth::user()->name}}" width="200px" height="200px">
            </div>
              ...
              <div class="active tab-pane" id="personal_info">
                <form class="form-horizontal" method="POST" action="{{ route('adminUpdateInfo') }}" id="AdminInfoForm" >
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputName2" placeholder="1 for admin, 2 for user" value="{{ Auth::user()->role}}" name="role">
